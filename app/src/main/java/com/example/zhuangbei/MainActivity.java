...
public class MainActivity extends AppCompatActivity {
    ...
    private void initFruits() {
        for (int i = 0; i < 2; i++) {
            all_star areyouok = new all_star(getRandomLengthName("ARE YOUR OK?"), R.drawable.areyouok);
            all_starList.add(areyouok);
            all_star jinitaimei = new all_star(getRandomLengthName("鸡你太美"), R.drawable.jinitaimei);
